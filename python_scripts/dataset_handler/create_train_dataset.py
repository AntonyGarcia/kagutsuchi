...
for pictures in os.scandir("../../images/exported_images/train_dataset"):  # Read al images in this path
    ...
    index = index + 1
    label = 0
    if pictures.path.find("pos.jpg") != -1:
        label = 1
...
pd.DataFrame(csv_array.get()).to_csv("../../datasets/train.csv", header=None)  # Save pixels in a file
